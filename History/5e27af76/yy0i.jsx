...
const UpdateProduct = () => {
  ...
  const { name, rating, _id, price, image, category, details } =
    useLoaderData();
  const handleFormSubmit = (e) => {
    ...
    axiosPub.put(`/products/${dataToUpdate._id}`, productsInfo).then((res) => {
        ...
        <form className="card-body" onSubmit={handleFormSubmit}>
          ...
          <div className="form-control">
            ...
            <input
              ...
              name="rating"
              placeholder="rating "
              defaultValue={dataToUpdate.rating}
              className="input input-bordered"
              required
            />
          </div>
          <div className="form-control">
            ...
            <textarea
              ...
              name="details"
              defaultValue={dataToUpdate.details}

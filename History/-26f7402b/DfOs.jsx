...
const Books = () => {
  ...
  const handleFavarite = (book) => {
    ...
    setIsFavorite([...books, updatedBook]);
  };
  return (
        ...
        <div className="space-y-3" key={book.id}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-xs lg:text-sm">
              ...
              {book.isFavrite ? (
                <button
                  className="flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#FB6B90]/[14%] py-1.5 text-[#1C4336] transition-all hover:bg-[#1C4336]/[24%] lg:py-1.5"

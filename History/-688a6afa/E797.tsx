    ...
    <div>
      ...
      >
        <CarouselContent className="-ml-4">
          <CarouselItem className="md:basis-1/3 lg:basis-1/5 border-2 ml-4 flex flex-col items-center justify-center ">
            <img
              src={fish}
              alt=""
          ...
          <CarouselItem className="md:basis-1/3 lg:basis-1/5 border-2 ml-4 flex flex-col items-center justify-center bg-blue-50">
          ...
          <CarouselItem className="md:basis-1/3 lg:basis-1/5 border-2 ml-4 mr-4 flex flex-col items-center justify-center ">

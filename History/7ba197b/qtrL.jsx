...
const Modal = ({ onClose, food }) => {
  ...
  return (
    <div className="bg-black  bg-opacity-85 w-full z-10 absolute top-0 left-0">
      <div className="hero h-full">
        <div className="card flex-shrink-0 mt-14 mb-14 w-full max-w-2xl mx-auto">
          <form
            className="grid md:grid-cols-2 gap-5 justify-center mt-10"
          ...
          >
            ...
            <div className=" flex gap-4 justify-center bg-black col-span-2">
              <button
                type="submit"

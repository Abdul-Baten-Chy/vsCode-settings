...
const NavBar = () => {
  const { user, signOutUser } = useContext(MyContextProvider);
      ...
      <div className="navbar  max-w-[1280px]  mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="navbar-end">
          {user ? (
            <button
              onClick={signOutUser}
              className="mr-3 bg-[#85F2C2] rounded-md hover:scale-x-110 px-2 py-1 transition duration-500 text-[#333333] font-bold"
            >
              Log out
            </button>
          ) : (

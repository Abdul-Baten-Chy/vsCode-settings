      ...
      <div className="px-10 flex gap-5 justify-center">
        <div className="">
          <img
            src={food.image}
            alt=""
            className="object-cover hover:scale-110 transition ease-in-out delay-100 duration-700 "
          />
        </div>
        <div className="ml-16">
          ...
          <div className="flex gap-8">
            <img
              src={food.donarImage}
              className="w-[70px] hover:scale-110 transition ease-in-out delay-100 duration-700"
              alt=""
            />
          ...
          <button className="bg-[#36D6A8] mt-10 w-2/3 h-[35px] text-white font-semibold hover:bg-[#73eecb] transition ease-in-out duration-700">
            Request Food
          </button>
        </div>
      </div>

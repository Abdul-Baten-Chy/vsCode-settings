...
const Login = () => {
  ...
  return (
    <Container>
      <div className="py-10 max-h-[calc(100vh-60px)]">
          ...
          <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://cdn.pixabay.com/photo/2018/02/12/09/00/the-market-3147758_1280.jpg')",
              }}
            ></div>
            <div className="w-full p-8 lg:w-1/2">
              <img src={logo} className="w-[150px] block mx-auto" alt="" />
              ...
              <form onSubmit={handleSubmit(handleFormSubmit)}><div className="mt-4 flex items-center justify-between">

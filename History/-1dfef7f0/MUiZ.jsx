              ...
              <tr key={singleEmployee._id}>
                ...
                >
                  {singleEmployee.isVerified ? (
                    <FaRegSquareCheck className="text-green-800" />
                  ) : (
                    <FaRegRectangleXmark className="text-red-800 hover:scale-105 transition duration-500" />
                  )}
                </th>
                <th>
                  <Link to="details">
                ...
                <th>
                  <button className="px-3 py-1 bg-[#FC6273] rounded-sm ">
                    Pay
                  </button>
                </th>
              </tr>

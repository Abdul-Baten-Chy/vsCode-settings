  ...
  return (
    <div className="flex mt-28 gap-10 max-w-[1280px] mx-auto px-14">
      <div className="flex-1 bg-[#FFF6F7] p-10 rounded-3xl">
        <h3 className="font-bold text-xl text-[#FC6075]">Who We Are </h3>
        <h2 className="text-5xl leading-snug font-bold mt-6 mb-24">
          Empower Your <br /> <span className="text-[#FC6075]">Workforce</span>,{" "}
          Elevate <br /> Your <span className="text-[#FC6075]">Success</span>
        </h2>
        <p>

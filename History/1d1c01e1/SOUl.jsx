...
const About = () => {
  return (
    <div className="flex mt-28 gap-10 max-w-[1280px] mx-auto px-14">
      <div className="flex-1 bg-[#FFF6F7] p-10 rounded-3xl hover:scale-105 hover:bg-[#f6bac1] transition duration-700 ease-in">
        <h3 className="font-bold text-xl text-[#FF9B44] hover:text-white">
          Who We Are{" "}
        </h3>

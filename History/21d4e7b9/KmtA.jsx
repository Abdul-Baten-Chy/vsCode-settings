    ...
    <div className="">
      <div className="w-[300px] h-[500px] mx-10 mb-10 bg-[#EDF7FB] drop-shadow-sm border-2">
        ...
        <div className="mt-6 pl-5">
          ...
          <p className="text-black font-bold mt-4">Your Title goes here</p>
          <div className="flex items-center gap-5 mt-5">
            <div className="w-14 h-14 rounded-full bg-black overflow-hidden">
              <img src={img} alt="" className="w-full object-fill" />
            </div>
            <h3 className="text-[#36D6A8]  text-[18px]">Donator Name</h3>
          </div>
          <div className="flex justify-center pr-5">
            <button className="bg-[#36D6A8] w-[70%] text-center text-white  py-2 mt-5 ">
              VIEW DETAILS
            </button>
          </div>
        </div>

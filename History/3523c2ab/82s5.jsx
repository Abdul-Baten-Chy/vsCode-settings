...
const Modal = ({ setIsOpenModal, selectedEmployee }) => {
  ...
  return (
    <>
      ...
      <div className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-white p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/3">
        ...
        <Elements stripe={stripePromise}>
          <CheckoutForm selectedEmployee={selectedEmployee}></CheckoutForm>
        </Elements>

...
const Dashboard = () => {
    ...
    axios.post("https://server-todo-nine.vercel.app/task", tasks).then((res) => {
...
const { data:tasks, refetch } = useQuery({
    queryKey: ['tasks'],
    queryFn: async () => {
      const res = await axios.get(`https://server-todo-nine.vercel.app/task/${userEmail}`)
      return res.data;
    },
  });
  ...
  const handleDelete = (_id)=>{
    console.log(_id);
    axios.delete(`https://server-todo-nine.vercel.app/task/${_id}`)
    .then((res) => {
      console.log(res.data);
...
const handleUpdate =(e)=>{
  e.preventDefault();
    ...
    axios.patch(`https://server-todo-nine.vercel.app/task/${editId}`, updatedTask)
    .then((res) => {
      console.log(res.data);

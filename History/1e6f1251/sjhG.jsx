...
const Dashboard = () => {
    ...
    axios.post("https://server-todo-3beh32vts-abdu-baten-chys-projects.vercel.app/task", tasks).then((res) => {
...
const { data:tasks, refetch } = useQuery({
    queryKey: ['tasks'],
    queryFn: async () => {
      const res = await axios.get(`https://server-todo-3beh32vts-abdu-baten-chys-projects.vercel.app/task/${userEmail}`)
      return res.data;
    },
  });
  ...
  const handleDelete = (_id)=>{
    console.log(_id);
    axios.delete(`https://server-todo-3beh32vts-abdu-baten-chys-projects.vercel.app/task/${_id}`)
    .then((res) => {
      console.log(res.data);
...
const handleUpdate =(e)=>{
  e.preventDefault();
    ...
    axios.patch(`https://server-todo-3beh32vts-abdu-baten-chys-projects.vercel.app/task/${editId}`, updatedTask)
    .then((res) => {
      console.log(res.data);

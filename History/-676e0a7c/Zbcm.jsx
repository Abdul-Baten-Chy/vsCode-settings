...
const About = () => {
  return (
    <div className="flex gap-14 max-h-[100vh] items-center  mt-20">
      <div className="w-1/2">
        <img src={img} alt="" />
      </div>
      <div className="w-1/2 bg-[#EDF7FB]">
        <p className="text-3xl w-40 p-2 tracking-wider transition duration-300 ease-in-out hover:bg-[#FCF0EF] text-[#36D6A8]">
          WHO WE ARE
        </p>

        <p className="text-[18px] leading-6 p-2 pr-10">

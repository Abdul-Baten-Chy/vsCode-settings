...
const url = "https://server-f5gqnlf1c-abdu-baten-chys-projects.vercel.app/";
const MyRequest = () => {
  ...
  const mutation = useMutation({
    mutationFn: async (ids) =>
      await axios.delete(
        `https://server-f5gqnlf1c-abdu-baten-chys-projects.vercel.app/reqFood/${ids}`
      ),
    onSuccess: () => {
  ...
  const updateAvailablityMutation = useMutation({
    mutationFn: async (ids) =>
      await axios.patch(
        `https://server-f5gqnlf1c-abdu-baten-chys-projects.vercel.app/foods/${ids}`
      ),
    onSuccess: () => {
